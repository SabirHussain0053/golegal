...
import { CommentsPlugin } from '@platejs/comment/react';
...
import { BaseBasicElementsPlugin } from '@platejs/basic-nodes';
import { BaseBasicMarksPlugin } from '@platejs/basic-nodes';
...
export const useCreateEditor = () => {
  return usePlateEditor({
    ...
    plugins: [
      ...
      JuicePlugin, // Inlines CSS properties for better compatibility
    ],
    value: [],
  });
};
