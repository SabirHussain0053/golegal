      ...
      <div className="flex-1 p-4">
        ...
        <div className="mb-4 flex justify-center">
          <ToolbarGroup>
            ...
            {/* New: Opens the full signature sidebar */}
            {/* <SignatureSidebar
                onApplySignature={(dataUrl) => {
                  // This uses your existing plugin to insert the signature
                  const insertSignature = ''.insertSignatureIntoEditor;
                  if (insertSignature) insertSignature(dataUrl);
                }}
              /> */}
          </ToolbarGroup>
        </div>
